    ...
    try {
      if (!acceptTermsAndCondition) {
        Swal.fire({
          icon: "info",
          iconColor: "green",
          text: "Please review and accept our terms and conditions before proceeding with your message.",
          ...
          <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
                ...
                <div className="flex flex-wrap gap-4 xl:justify-between">
                  <div className="mb-4 flex md:mb-0">
                    ...
                    >
                      ...
                      <a href="#">Terms and Conditions</a>, and consent to our{" "}
            ...
            >
              ...
              <div className="5 mb-7">
                ...
                <p>
                  Block A, VGN Southern Avenue, Wilt Street, Potheri, Chennai,
                  Tamil Nadu - 603202
                </p>
              </div>
              <div className="5 mb-7">
                ...
                <p>
                  <a href="mailto:contact@waitlistninja.com">
              ...
              <div>
                ...
                <p>
                  <a href="tel:+917980058367">+91 7980058367</a>
                </p>
              </div>
            </motion.div>
          </div>
